...
class TrainingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TrainModel = channel.unary_unary(
                '/train.TrainingService/TrainModel',
                request_serializer=train__pb2.CleanedData.SerializeToString,
...
def add_TrainingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'TrainModel': grpc.unary_unary_rpc_method_handler(
                    servicer.TrainModel,
                    request_deserializer=train__pb2.CleanedData.FromString,
                    response_serializer=train__pb2.TrainResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'train.TrainingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('train.TrainingService', rpc_method_handlers)
...
class TrainingService(object):
    ...
    def TrainModel(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/train.TrainingService/TrainModel',
            train__pb2.CleanedData.SerializeToString,
